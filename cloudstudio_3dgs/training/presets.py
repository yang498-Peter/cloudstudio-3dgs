...
TRAINER_PRESETS: dict[str, dict[str, Any]] = {
    ...
    # Keep every Australian P5 appearance control unchanged, while adding the
    # smallest short-probe linear metric term that materially reduced depth
    # error. This remains a Gate 2 candidate, not a promoted production default.
